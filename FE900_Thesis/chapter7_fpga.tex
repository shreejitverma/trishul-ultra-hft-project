...
\begin{itemize}
    ...
    \item \textbf{UDP\_EXTRACT (Cycle 2):} Parses the 8-byte UDP header. The module performs a parallel lookup against a programmable \textbf{Port Whitelist} (stored in Registers/LUTs) to filter for specific multicast market data feeds (e.g., NASDAQ ITCH).
