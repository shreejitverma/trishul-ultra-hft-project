...
\begin{axis}[
    ...
    xlabel={Time during Volatility Spike (ms)},
    ylabel={Cumulative PnL ($\$$)},
    xmin=0,
    xmax=100,
    grid=major,
    grid style={dashed, gray!30},
    title={Adaptive Mitigation of Adverse Selection},
