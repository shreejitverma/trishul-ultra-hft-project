...
\begin{enumerate}
    \item \textbf{Traditional Software Stack:} This baseline represents the standard high-performance trading architecture utilized by most quantitative firms. It consists of optimized C++ code running on general-purpose CPUs, utilizing **Kernel-Bypass (User-space networking)** and **Core Pinning** to minimize OS overhead. While highly flexible, it is subject to non-deterministic ``jitter'' caused by L3 cache contention, branch mispredictions, and unavoidable kernel interrupts.
